Shader "Unlit/LightFieldVertex"
{
	SubShader
	{
		...
		Pass
		{
			...
			uniform StructuredBuffer<float> determinantList; // sqrt(determinat(coMatrix))
			...
			v2f vert(appdata v)
			{
                ...
                float4 x = float4(mouseX,mouseY, o.vertex.x/_ScreenParams.x, o.vertex.y/_ScreenParams.y);
